...
class Init_ComputeRectangleArea_Request_lenght
{
public:
  Init_ComputeRectangleArea_Request_lenght()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  Init_ComputeRectangleArea_Request_width lenght(::my_robot_interfaces::srv::ComputeRectangleArea_Request::_lenght_type arg)
  {
...
{
  return my_robot_interfaces::srv::builder::Init_ComputeRectangleArea_Request_lenght();
}
